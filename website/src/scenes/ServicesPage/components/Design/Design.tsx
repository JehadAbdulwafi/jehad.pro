  ...
  const items = [
    {
      ...
      text: "We create comprehensive and sophisticated yet simple to use interfaces for your web app.",
      image: websitesDesign,
    },
    {
      title: "Mobile Apps Design",
      text: "We create native mobile apps with a focus on natural gestures and interactions with the user.",
      image: mobileAppsDesign,
    },
    {
      title: "UX/UI Design",
      text: "We design the flow of a multi-screen app, interactions and animations, to make interface feel amazing.",
      image: uxUiDesign,
    },
    {
      title: "Branding",
      text: "We don't just create logos, we help our partners establish an all-encompassing brand experience.",
      image: branding,
    },
  ];
